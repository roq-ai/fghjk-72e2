...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'excel_data.create': {
    roles: ['data-analyst'],
    key: 'excel-data-uploaded',
    tenantPath: ['organization', 'excel_data'],
    userPath: [],
  },
  'algorithm.create': {
    roles: ['organization-owner'],
    key: 'algorithm-applied',
    tenantPath: ['organization', 'user', 'algorithm'],
    userPath: [],
  },
  'excel_data.delete': {
    roles: ['data-analyst'],
    key: 'excel-data-deleted',
    tenantPath: ['organization', 'excel_data'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['organization-owner', 'data-analyst'];
