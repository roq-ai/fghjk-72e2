...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['organization-owner', 'data-analyst'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Algorithms', path: '/algorithms', entity: 'algorithm', service: AccessServiceEnum.PROJECT, icon: FiCode },
    {
      name: 'Excel Data',
      path: '/excel-data',
      entity: 'excel_data',
    ...
    { name: 'Results', path: '/results', entity: 'result', service: AccessServiceEnum.PROJECT, icon: FiCheckSquare },
